...
int DAEHiggs( TString myMethodList = "" )
{
   ...
   TString fname = "/home/mhuwiler/dataset/HiggsML_new_2.root";
   ...
   TTree *signal     = (TTree*)input->Get("sig_tree");
   TTree *background = (TTree*)input->Get("bkg_tree");
   
   // Create a ROOT output file where TMVA will store ntuples, histograms, etc.
   TString outfileName( "TMVAexample.root" );
   ...
   dataloader->AddVariable("missing_energy_phi",'F');
   ...
   //                                         "NSigTrain=10000:NBkgTrain=10000:NSigTest=10000:NBkgTest=10000:SplitMode=Random:!V" );

   /// move from 50000 to 100
   int ntrainEvts = 500;
   int ntestEvts =  500; 
...
///       TString layoutString ("Layout=TANH|100,TANH|50,TANH|10,LINEAR");
       ...
       TString training0 ("LearningRate=1e-1,Momentum=0.0,Repetitions=1,ConvergenceSteps=300,BatchSize=20,TestRepetitions=15,WeightDecay=0.001,Regularization=NONE,DropConfig=0.0+0.5+0.5+0.5,DropRepetitions=1,Multithreading=False");
       TString training1 ("LearningRate=1e-2,Momentum=0.5,Repetitions=1,ConvergenceSteps=300,BatchSize=30,TestRepetitions=7,WeightDecay=0.001,Regularization=L2,Multithreading=False,DropConfig=0.0+0.1+0.1+0.1,DropRepetitions=1");
       TString training2 ("LearningRate=1e-2,Momentum=0.3,Repetitions=1,ConvergenceSteps=300,BatchSize=40,TestRepetitions=7,WeightDecay=0.0001,Regularization=L2,Multithreading=False");
       TString training3 ("LearningRate=1e-3,Momentum=0.1,Repetitions=1,ConvergenceSteps=200,BatchSize=70,TestRepetitions=7,WeightDecay=0.0001,Regularization=NONE,Multithreading=False");
...
//       TString nnOptions ("!H:V:VarTransform=Normalize:ErrorStrategy=CROSSENTROPY");
       TString nnOptions ("!H:V:ErrorStrategy=CROSSENTROPY:VarTransform=G:WeightInitialization=XAVIERUNIFORM:Architecture=CPU");
//       TString nnOptions ("!H:V:VarTransform=Normalize:ErrorStrategy=CHECKGRADIENTS");
   ...
   // Support Vector Machine
   if (Use["SVM"])
      factory->BookMethod( dataloader, TMVA::Types::kSVM, "SVM", "Kernel=RBF:Gamma=0.25:Tol=0.001:VarTransform=Norm" );
...
//   factory->BookMethod(dataloader, TMVA::Types::kRXGB, "RXGB","!V:NRounds=80:MaxDepth=2:Eta=1" );
   ...
   // R NN
//   factory->BookMethod(dataloader, TMVA::Types::kRSNNS, "RMLP","!H:VarTransform=N:Size=c(5):Maxit=800:InitFunc=Randomize_Weights:LearnFunc=Std_Backpropagation:LearnFuncParams=c(0.2,0):!V" );
 
   //PyMVA
//    factory->BookMethod(dataloader, TMVA::Types::kPyGTB, "PyGTB","!V:NEstimators=500:Loss=deviance:LearningRate=0.1:Subsample=1:MaxDepth=3:MaxFeatures='auto'" );
   // factory->BookMethod(dataloader, TMVA::Types::kPyRandomForest, "PyRandomForest","!V:NEstimators=500:Criterion=gini:MaxFeatures=auto:MaxDepth=6:MinSamplesLeaf=3:MinWeightFractionLeaf=0:Bootstrap=kTRUE" );
   // factory->BookMethod(dataloader, TMVA::Types::kPyAdaBoost, "PyAdaBoost","!V:NEstimators=500" );
   ...
   if (Use["BDT"])  // Adaptive Boost
      factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT",
                           "!H:!V:NTrees=850:MinNodeSize=2.5%:VarTransform=A:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20" );
